#ifndef SANDBOX_OPENGL_22_GL_APP_APPLICATION_CONTEXT_H_
#define SANDBOX_OPENGL_22_GL_APP_APPLICATION_CONTEXT_H_
...
#endif //SANDBOX_OPENGL_22_GL_APP_APPLICATION_CONTEXT_H_
