...
public:
    ...
    // 頂点 3D Cube
    // GL_TRIANGLES
    [[maybe_unused]] constexpr static float kCubeWithNormalVertices[] = {
            // x, y, z, NormalVector.x, y, z
    ...
    [[maybe_unused]] constexpr static float kCubeWithNormalAndTexcoordVertices[] = {
            // x, y, z, NormalVector.x, y, z, Texcoord.s, t
